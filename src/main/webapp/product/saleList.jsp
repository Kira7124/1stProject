	       ...
	       <div class="card mb-4">
		      	<div class="card-header pb-0">
		            ...
		            <h6>내 기기 판매</h6>
			      	...
			      	<form action="./SaleListAction.pd" method="post" >
	  	     	 ...
	  	     	 <div class="product-container">
	  	     	 	<ul class="pd_list">
	  	     	 		<li>
	  	     	 		<div>
	  	     	 			<a href="./saleDetail.pd?product_id=${dto.product_id }"><img src="./img/${dto.image }" class="pd_img"></a>
	  	     	 		</div>
	  	     	 		<div class="table-container">
	     	 				<a href="./saleDetail.pd?product_id=${dto.product_id }"><span class="mb-0 text-sm">${dto.name }</span></a>
	     	 			</div>
	     	 			<ul>
	     	 					...
	     	 					<li><p class="mb-0 text-sm">S급 <fmt:formatNumber value="${dto.price}" pattern="#,###" />원</p></li>
	     	 					<li><p class="mb-0 text-sm">A급 <fmt:formatNumber value="${dto.price*0.8}" pattern="#,###" />원</p></li>
	     	 					<li><p class="mb-0 text-sm">B급 <fmt:formatNumber value="${dto.price*0.6}" pattern="#,###" />원</p></li>
	     	 			</ul>
	  	     	 		</li>
	  	     	 	</ul>
	  	     	 </div>
