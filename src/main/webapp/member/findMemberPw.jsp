...
<script src="js/findMemberPw.js"></script>
	    ...
	    <div class="login-form-bg">
	    	<div class="login-form">
	    		...
	    		<div class="login-input" style="margin-top: 80px;">
			        <form action="./findMemberPwAction.me" method="post">
			            <p>아이디</p>
			            <span><input type="text" placeholder="&nbsp;&nbsp;아이디" name="inputId" id="input-id"></span>
			            <p>아이디에 등록한 이메일</p>
			            <span><input type="email" placeholder="&nbsp;&nbsp;이메일" name="inputEmail" id="input-email"></span>
			            <p>인증번호 입력란</p>
			            ...
			            <p><input type="submit" class="login-bt" value="비밀번호 찾기" onclick="return clickFindPw();"></p>
			        </form>
	    		</div>
	   		</div>
   		</div>
