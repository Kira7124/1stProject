...
<body>
	...
	<!-- 메인페이지 -->
	<div id="product-row">
	<form action="./QNAUpdateProAction.bo?pageNum=${pageNum }"
		...
		<div class="productWrite-bg mb-4">
			...
			<table>
				<tr class="writeForm">
					<th colspan="2" id="th">문의글 수정하기</th>	
				</tr>
				<tr class="writeForm">
					<td>문의상품 :</td>
					<td>${bdto.productname }</td>
				</tr>
				<tr class="writeForm">
					<td>작성자 :</td>
					<td>${bdto.id }</td>	
				...
				<tr class="writeForm">
					<td>문의 제목 : </td>
					<td><input id="input1" type="text" name="board_subject" value="${bdto.board_subject }"></td>		
				</tr>
				<tr class="writeForm">
					<td>문의 내용 : </td>
					<td>
						<textarea id="cont"  name="board_content" rows="10" cols="100" >${bdto.board_content }</textarea>
					</td>
				</tr>
				<tr class="writeForm">
					<td>이미지 첨부</td>
					<td>
						...
						<input type="file" name="board_file" id="im" accept=".jpg" value="${bdto.board_file }">
				...
				<tr class="writeForm">
					<td>글 비밀번호 : </td>
					<td>
						<input id="input1" type="password" name="board_pass" value="${bdto.board_pass }">
					</td>
				</tr>	
			</table>
			<div>
