...
<body>
	...
	<!-- 메인페이지 -->
	<div id="product-row">
		<form action="AnnouncementWriteAction.bo" method="post" enctype="multipart/form-data" >
		<div class="productWrite-bg mb-4">
			<div class="card-header pb-0">
			</div>
			<table>
				<tr class="writeForm">
					<th colspan="2" id="th">공지사항 작성하기</th>	
				</tr>
				<tr class="writeForm">
					<td>카테고리 : </td>
					<td>
						<input type="radio" name="board_category"  value="NOTICE" id="normal" checked="checked">
						<label class="radio-part" for="normal">일반</label>
						<input type="radio" name="board_category"  value="중요" id="imp">
						<label class="radio-part" for="imp">중요</label>
				...
				<tr class="writeForm">
					<td>공지사항 제목 : </td>
					<td><input type="text" name="board_subject" id="sub" required></td>		
				</tr>
				<tr class="writeForm">
					<td>공지사항 내용 : </td>
					<td>
