...
public class FindIdAuthNumberRequestAction {	

	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println(" M : FindIdAuthNumberRequestAction.execute() 실행");
		
		request.setCharacterEncoding("utf-8");
		String inputEmail = request.getParameter("inputEmail");
		MemberDAO mdao = new MemberDAO();
		String result = mdao.findMemberId(inputEmail);
		System.out.println(" M : findMemberId 결과 : " +result);
		if (result == null) {
		...
		//Ajax에 응답==============================================
				...
				response.getWriter().write(randomNum);
