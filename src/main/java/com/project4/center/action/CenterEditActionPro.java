...
public class CenterEditActionPro implements Action {
...
//		System.out.println("M: " + cdto);
		...
		// DAO 객체 생성 및 asEdit() 메서드 실행
		CenterDAO cdao = new CenterDAO();
		cdao.asEdit(cdto);
		
		// 페이지 이동
		JSMoveFunction.confirmLocation(response, "A/S 신청서를 수정하시겠습니까?", "A/S 신청서 수정 완료!", "./myPage.me");
